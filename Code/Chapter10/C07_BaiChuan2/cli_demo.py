...
def init_model():
    print("init model ...")
    model = BaichuanForCausalLM.from_pretrained("./Baichuan2_7B_Chat",
...
def clear_screen():
    if platform.system() == "Windows":
        ...
        os.system("clear")
    print(
        Fore.YELLOW + Style.BRIGHT + "欢迎使用百川大模型，输入进行对话，vim 多行输入，clear 清空历史，CTRL+C 中断生成，stream 开关流式生成，exit 结束。")
    return []
